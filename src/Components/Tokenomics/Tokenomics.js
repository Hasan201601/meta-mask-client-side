                ...
                <div className="grid grid-cols-12 gap-4 ">
                    ...
                    <div className="col-span-12 lg:col-span-6 content-center items-center flex">
                        ...
                        >
                            ...
                            60% of the total supply will be locked into our native DEX portal, iLoopSwap.

                            </p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">8% dedicated to the community.
                            </p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">5% is allocated to charity
                            </p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">5% goes to the Public Presale IDO.</p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">
                            5% is locked in PancakeSwap.</p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">
                            5% is locked in UniSWAP DEX.</p> 
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">
                            5% goes to Private Presale IDO</p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">
                            5% dedicated to Burn/Buybacks.</p>
                            <p className="text-[#a7a1aa] text-[16px] md:text-[20px] text-center lg:text-left font-bold">
                            2% goes to the team </p>
